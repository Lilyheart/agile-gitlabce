...
window.Feedback.Screenshot.prototype.start = function( modal, modalHeader, modalFooter, nextButton ) {
    ...
    if ( this.h2cDone ) {
        ...
        this.dom.appendChild( element("p", "Be sure to blackout any confidential information.") );

        // add highlight and blackout buttons
        for (var i = 0; i < 2; i++ ) {
            buttonItem[ i ].className = 'btn feedback-btn ' + (i === 0 ? 'active' : 'feedback-btn-inverse');
